...
# defining a function that recommends 3 most similar courses
def rcmd(m):
    m = m.lower()
    ...
    try:
        ...
        data, sim = create_sim()
    # check if the course is in our database or not
    if m not in data['course'].unique():
        return('This course is not in our database.\nPlease check if you spelled it correct.')
    else:
        # getting the index of the course in the dataframe
        ...
        # taking top 1- course scores
        # not taking the first index since it is the same movie
        lst = lst[1:4]

        # making an empty list that will containg all 3 course recommendations
        l = []
